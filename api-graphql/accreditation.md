...
Les **jetons d'API sont accessibles aux usagers ayant un compte administrateur** sur **demarche.numerique.gouv.fr**. Le jeton d'un administrateur ne donne un accès à l'API qu'aux démarches de ce compte administrateur (voir même qu'à une liste limitée de ces démarches).
