...
* Toutes les versions d'une démarche (au travers des objets `Revision` : [https://www.demarches-simplifiees.fr/graphql/schema/types/Revision](https://www.demarches-simplifiees.fr/graphql/schema/types/Revision)).
* Une `Revision` porte le schema de donnée des dossiers déposés lorsque la démarche était sur cette version. Vous trouverez donc la liste des champs et des annotations sur la révision cf: [https://www.demarches-simplifiees.fr/graphql/schema/types/ChampDescriptor](https://www.demarches-simplifiees.fr/graphql/schema/types/ChampDescriptor)
