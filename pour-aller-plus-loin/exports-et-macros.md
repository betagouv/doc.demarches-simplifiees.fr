...
Les scripts (macros) sont un moyen très efficace pour gagner du temps. Néanmoins, ils nécessitent des mises à jour fréquentes, en particulier lorsque le format de la feuille change (et il changera).
...
1. Laissez tomber l'export excel, et utilisez l'[api](/broken/pages/-LtV6Sq8EufAJmOunFik)
