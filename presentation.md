...
Si chaque administration fait le choix de développer ses propres outils informatiques, au lieu d’utiliser un outil mutualisé comme **demarche.numerique.gouv.fr**, ce sont des dizaines de millions d’euros qui seront dépensés en pure perte…
...
* **La dématérialisation des procédures** : le traitement et la soumission d’informations doivent être simplifiés ;
