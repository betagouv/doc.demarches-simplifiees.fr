...
<figure><img src="../.gitbook/assets/image (59).png" alt=""><figcaption><p>Champ "Carte" en tant qu'usager </p></figcaption></figure>
...
Le champ référentiel à configurer (avancé) permet à l’usager de saisir un identifiant (ex : SIRET, plaque d’immatriculation, numéro RNA ou autre…) qui sera validé en temps réel auprès d’un référentiel externe (API).\
Ce champ est idéal pour garantir que la donnée saisie existe bien dans une base officielle ou métier.

#### Fonctionnement

* L’usager saisit un identifiant dans le champ référentiel à configurer (avancé).
* Lors de la validation, la plateforme interroge l’API du référentiel externe avec l'identifiant saisit par l'usager
...
#### Configuration du champ référentiel avancé

1. **Ajouter un champ référentiel avancé**
   * Dans l’éditeur de formulaire, ajoutez un champ de type “référentiel à congifurer avancé”.
2. **Cliquer sur "Configurer le champs"**&#x20;
3.  **Configurer l’URL du référentiel**

    * Renseignez l’URL de l’API à interroger.
...
6. **Utiliser le champ `Exemple de saisie valide (affiché à l'usager et utilisé pour tester la requête)`**
   ...
   * L'API sera appellée avec cette valeur pour valider que votre API répond selon nos standard (pour le moment, nous acceptons les référentiel qui réapondent à une requete HTTP GET, au format JSON, le status http qui permet de valider que votre référentiel est bien configuré est le 200).

***

## 2. Pré-remplissage automatique des champs via le référentiel

### Qu’est-ce que le pré-remplissage référentiel ?

Le pré-remplissage par référentiel à configuré (avancé) permet d’automatiser la saisie de certains champs du formulaire à partir de données issues d’une base externe (référentiel).

***

### Comment configurer le pré-remplissage ?

#### a. Accéder à la configuration du mapping

* Une fois l'URL de 'API renseignée ainsi que la donnée de test, vous pourrez visualiser la réponse de l'appel à l'API

<figure><img src="../.gitbook/assets/Capture d’écran 2025-06-17 à 10.02.03 AM.png" alt=""><figcaption></figcaption></figure>

#### b. De la vous pourrez choisir les propriétés du JSON qui serviront à pré-remplir d'autres champs

* Pour chaque champ du formulaire, vous pouvez choisir de le lier à une donnée du référentiel.
* Utilisez l’interface de mapping pour sélectionner la donnée source (chemin JSON)&#x20;

<figure><img src="../.gitbook/assets/Capture d’écran 2025-06-17 à 10.03.52 AM.png" alt=""><figcaption></figcaption></figure>

#### c. Puis vous pouvez associer les propriétés du JSON à des champs du formulaire

<figure><img src="../.gitbook/assets/Capture d’écran 2025-06-17 à 10.06.30 AM.png" alt=""><figcaption></figcaption></figure>

#### Gérer les répétitions (tableaux)

* Si la donnée source est un tableau (ex : liste d’enfants, de parcelles…), vous pouvez lier chaque élément à une répétition du formulaire.
* Le système créera automatiquement autant de lignes que d’éléments dans le tableau.

***

### Visualiser le mapping configuré

* Un résumé du mapping s’affiche dans la fiche du champ référentiel : il liste les correspondances entre les données du référentiel et les champs du formulaire.

<figure><img src="../.gitbook/assets/Capture d’écran 2025-06-17 à 10.07.46 AM.png" alt=""><figcaption></figcaption></figure>
...
### Que se passe-t-il si une donnée n’est pas trouvée ou est incomplète ?
...
### Types de données supportés et correspondance avec les champs du formulaire

| Type de donnée référentiel (JSON)    | TypeDeChamp cible dans le formulaire     | Remarques principales                        |
| ------------------------------------ | ---------------------------------------- | -------------------------------------------- |
...
* Les types avancés (SIRET, IBAN, etc.) sont mappé directement, puis validé à la soumission du dossier.
...
<figure><img src="../.gitbook/assets/image (67).png" alt=""><figcaption><p>Personnaliser les email, en tant qu'administrateur </p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (75).png" alt=""><figcaption><p>Exemple de balises possibles, en tant qu'administrateur </p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (78).png" alt=""><figcaption><p>Nommer des instructeurs, en tant qu'administrateur </p></figcaption></figure>
