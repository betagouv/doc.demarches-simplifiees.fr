...
* [API](api/README.md)
  ...
  * [Jeton d'authentification](api/jeton-dauthentification/README.md)
    * [Problèmes fréquents](api/jeton-dauthentification/problemes-frequents.md)
  ...
  * [Cas d'usages / exemple d'implémentation](api/cas-dusages-exemple-dimplementation/README.md)
    * [Autentification](api/cas-dusages-exemple-dimplementation/autentification.md)
    * [Récupérer tous les dossiers (pagination)](api/cas-dusages-exemple-dimplementation/recuperer-tous-les-dossiers-pagination.md)
    * [Télécharger les fichiers uploadé par un usager sur son dossier](api/cas-dusages-exemple-dimplementation/telecharger-les-fichiers-uploade-par-un-usager-sur-son-dossier.md)
